    ...
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="Установить время", callback_data="set_user_time"
            ),
        ...
        [
            ...
            InlineKeyboardButton(
                text="Удалить город", callback_data="delete_users_city"
            ),
        ],
        [
            InlineKeyboardButton(
                text="↩️ Отменить действие", callback_data="cancel_action"
            )
        ],
    ]
)
...
time_exist_ikb = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="🗑 Удалить время", callback_data="delete_time"),
            InlineKeyboardButton(
...
no_time_ikb = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="📌 Установить время", callback_data="set_user_time"
        ...
        [
            InlineKeyboardButton(
                text="↩️Отменить действие", callback_data="cancel_action"
            )
        ],
    ]
)
...
city_exist_ikb = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="🗑 Удалить город", callback_data="delete_users_city"
...
city_not_exist_ikb = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="📌 Установить город", callback_data="set_users_city"
            ),
            InlineKeyboardButton(
                text="↩️ Отменить действие", callback_data="cancel_action"
            ),
